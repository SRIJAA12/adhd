...
import { Box, Grid, Avatar, Typography, Card, CardActionArea, CardContent, Fab, Badge, Button, Paper } from '@mui/material';
          ...
          <Grid container spacing={2} alignItems="center">
            <Grid item xs={12} md={8}>
              ...
              <Typography variant="body2" sx={{ color: 'rgba(255,255,255,0.9)' }}>
                Add a focus session to your Google Calendar and build a consistent routine!
              </Typography>
            </Grid>
            <Grid item xs={12} md={4} textAlign="right">
              <Button
                ...
                onClick={() => addToGoogleCalendar(25)}
                sx={{
                  bgcolor: 'white',
                  color: '#4285f4',
                  fontWeight: 700,
